...
class DocumentsRelationManager extends RelationManager
{
    ...
    // No create/delete here - documents belong to the upload workflow,
    // not something an admin adds directly from a matter's relation tab.
    public function isReadOnly(): bool
    {
        return false; // keep actions enabled, just no create form
    }
}

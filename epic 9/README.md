...
Services: ClientService, MatterService, DocumentService,
          ...
          ResearchService, TaskService, TimelineService
    |
    v
...
Run the app and the queue worker in separate terminals — extraction and AI analysis won't process without the worker running:
...
*(add a seeded demo user's email/password here once demo seed data exists)*

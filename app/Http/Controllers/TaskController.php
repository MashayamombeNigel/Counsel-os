...
class TaskController extends Controller
{
    ...
    /**
     * Handles both manual task creation and "convert AI deadline to task" —
     * the latter arrives with source_document_id already set from the prefilled
     * form in the AI Insights tab.
     */
